...
namespace Finance_Tracker.Migrations
{
    ...
    [Migration("20260710150921_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finance_Tracker.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Finance_Tracker.Models.Account", b =>
                {
                    b.HasOne("Finance_Tracker.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Finance_Tracker.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
